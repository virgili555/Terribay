...
/obj/machinery/gravity_generator/main/proc/grav_on()
	if(!using_map.station_levels)
		message_admins("using_map.station_levels is blank. Gravgen isn't properly established.")
		return
...
/obj/machinery/gravity_generator/main/proc/pulse_radiation()
	for(var/mob/living/L in view(7, src))
		L.apply_effect(20, IRRADIATE, blocked = L.getarmor(null, "rad"))
